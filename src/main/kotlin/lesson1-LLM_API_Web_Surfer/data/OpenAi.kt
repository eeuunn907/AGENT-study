package `lesson1-LLM_API_Web_Surfer`.data
...
import kotlinx.serialization.json.jsonObject
import params
import `lesson1-LLM_API_Web_Surfer`.data.datasource.availableFunctions
...
import `lesson1-LLM_API_Web_Surfer`.domain.key.openAiKey
