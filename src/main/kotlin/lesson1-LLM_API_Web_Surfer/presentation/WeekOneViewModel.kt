package `lesson1-LLM_API_Web_Surfer`.presentation

import kotlinx.coroutines.launch
import kotlinx.coroutines.runBlocking
import `lesson1-LLM_API_Web_Surfer`.data.OpenAiRepositoryImpl
import `lesson1-LLM_API_Web_Surfer`.domain.usecase.CallOpenAiUseCase
